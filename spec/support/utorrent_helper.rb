...
module UTorrentHelper
  ...
  def utorrent_stub
    ...
    obj.stub(:get_utorrent_settings) { ut_settings_data }

    obj
  end

  def ut_settings_data
    [
      ["install_revision", 0, "37754", {"access"=>"Y"}],
      ...
      ["mainwndstatus", 0, "4", {"access"=>"Y"}],
      ["mainwnd_split", 0, "209", {"access"=>"Y"}],
      ["mainwnd_split_x", 0, "235", {"access"=>"Y"}],
      ["playback_split_x", 0, "-1", {"access"=>"Y"}],
      ["show_general_tab", 1, "true", {"access"=>"Y"}],
      ["show_pulse_tab", 1, "true", {"access"=>"Y"}],
      ...
      ["offers.featured_content_rss_update_interval", 0, "3600", {"access"=>"Y"}],
      ["offers.featured_content_rss_randomize", 1, "true", {"access"=>"Y"}],
      ["offers.404_dismiss", 0, "1422322066", {"access"=>"Y"}],
      ["offers.404_shown", 0, "1422322066", {"access"=>"Y"}],
      ["offers.404_url", 2, "https://utclient.utorrent.com/offers/streaming-2/i18n/en/index-ut.html", {"access"=>"Y"}],
      ...
      ["confirm_when_deleting", 1, "false", {"access"=>"Y"}],
      ...
      ["settings_saved_systime", 0, "1423650601", {"access"=>"R"}],
      ...
      ["tray.single_click", 1, "true", {"access"=>"Y"}],
      ["activate_on_file", 1, "true", {"access"=>"Y"}],
      ["check_assoc_on_start", 1, "true", {"access"=>"Y"}],
      ["bind_port", 0, "26430", {"access"=>"Y"}],
      ["dir_active_download_flag", 1, "true", {"access"=>"Y"}],
      ["dir_torrent_files_flag", 1, "true", {"access"=>"Y"}],
      ["dir_completed_download_flag", 1, "true", {"access"=>"Y"}],
      ["dir_completed_torrents_flag", 1, "true", {"access"=>"Y"}],
      ["dir_active_download", 2, "C:\\XMBC-Apps\\Torrents\\downloads-tmp\\", {"access"=>"Y"}],
      ["dir_torrent_files", 2, "C:\\XMBC-Apps\\Torrents\\downloads-tmp\\torrents\\", {"access"=>"Y"}],
      ["dir_completed_download", 2, "C:\\XMBC-Apps\\Torrents\\downloads-completed\\", {"access"=>"Y"}],
      ["dir_completed_torrents", 2, "C:\\XMBC-Apps\\Torrents\\downloads-tmp\\torrents-finished\\", {"access"=>"Y"}],
      ...
      ["gui.persistent_labels", 2, "TV|Movie|Music|App", {"access"=>"Y"}],
      ...
      ["ul_slots_per_torrent", 0, "4", {"access"=>"Y"}],
      ["conns_per_torrent", 0, "50", {"access"=>"Y"}],
      ["conns_globally", 0, "200", {"access"=>"Y"}],
      ["max_active_torrent", 0, "8", {"access"=>"Y"}],
      ["max_active_downloads", 0, "5", {"access"=>"Y"}],
      ["seed_prio_limitul", 0, "0", {"access"=>"Y"}],
      ["seed_prio_limitul_flag", 1, "true", {"access"=>"Y"}],
      ...
      ["upnp.external_tcp_port", 0, "26430", {"access"=>"R"}],
      ["upnp.external_udp_port", 0, "26430", {"access"=>"R"}],
      ["upnp.external_ip", 2, "192.168.1.173", {"access"=>"R"}],
      ["natpmp", 1, "true", {"access"=>"Y"}],
      ["lsd", 1, "false", {"access"=>"Y"}],
      ["disable_fw", 1, "true", {"access"=>"Y"}],
      ["dw", 0, "109416386", {"access"=>"R"}],
      ["fd", 0, "2709", {"access"=>"R"}],
      ["v", 0, "109417338", {"access"=>"R"}],
      ["asdns", 0, "0", {"access"=>"R"}],
      ["ascon", 0, "0", {"access"=>"R"}],
      ["asdl", 0, "0", {"access"=>"R"}],
      ["sched_enable", 1, "false", {"access"=>"Y"}],
      ["sched_ul_rate", 0, "10", {"access"=>"Y"}],
      ["sched_interaction", 1, "false", {"access"=>"Y"}],
      ["sched_dl_rate", 0, "50", {"access"=>"Y"}],
      ["sched_table", 2, "000000022222222222100111000000022222222222100111000000022222222222100111000000022222222222100111000000022222222222100111000000011111111111111111000000011111111111111111", {"access"=>"Y"}],
      ["sched_dis_dht", 1, "true", {"access"=>"Y"}],
      ["enable_scrape", 1, "true", {"access"=>"Y"}],
      ["show_toolbar", 1, "true", {"access"=>"Y"}],
      ["show_details", 1, "true", {"access"=>"Y"}],
      ["show_status", 1, "true", {"access"=>"Y"}],
      ["show_category", 1, "true", {"access"=>"Y"}],
      ["show_tabicons", 1, "true", {"access"=>"Y"}],
      ["rand_port_on_start", 1, "true", {"access"=>"Y"}],
      ["prealloc_space", 1, "false", {"access"=>"Y"}],
      ["language", 0, "-1", {"access"=>"Y"}],
      ["logger_mask", 0, "0", {"access"=>"Y"}],
      ["autostart", 1, "true", {"access"=>"Y"}],
      ["dht", 1, "false", {"access"=>"Y"}],
      ["dht_per_torrent", 1, "false", {"access"=>"Y"}],
      ["pex", 1, "false", {"access"=>"Y"}],
      ["rate_limit_local_peers", 1, "false", {"access"=>"Y"}],
      ...
      ["is_plus_active", 1, "false", {"access"=>"R"}],
      ...
      ["bt.transp_disposition", 0, "21", {"access"=>"Y"}],
      ...
      ["net.discoverable", 1, "true", {"access"=>"Y"}],
      ...
      ["bt.allow_same_ip", 1, "false", {"access"=>"Y"}],
      ...
      ["webui.enable", 0, "1", {"access"=>"Y"}],
      ["webui.enable_guest", 0, "0", {"access"=>"Y"}],
      ["webui.enable_listen", 0, "1", {"access"=>"Y"}],
      ["webui.token_auth", 1, "true", {"access"=>"Y"}],
      ["webui.token_auth_filter", 0, "0", {"access"=>"Y"}],
      ["webui.username", 2, "admin", {"access"=>"Y"}],
      ["webui.uconnect_enable", 1, "false", {"access"=>"Y"}],
      ["webui.uconnect_username", 2, "xbmc", {"access"=>"Y"}],
      ["webui.uconnect_question_opted_out", 1, "false", {"access"=>"R"}],
      ["webui.allow_pairing", 1, "true", {"access"=>"Y"}],
      ["webui.ssdp_uuid", 2, "2c4bf4f3-e252-e111-8c49-80ee73136206", {"access"=>"R"}],
      ["webui.guest", 2, "guest", {"access"=>"Y"}],
      ["webui.port", 0, "8082", {"access"=>"Y"}],
      ["webui.cookie", 2, "{\"showDetails\":true,\"showDetailsIcons\":true,\"showCategories\":true,\"showToolbar\":true,\"showStatusBar\":true,\"useSysFont\":true,\"updateInterval\":3000,\"maxRows\":0,\"lang\":\"en\",\"hSplit\":-1,\"vSplit\":-1,\"torrentTable\":{\"colMask\":995592,\"colOrder\":[],\"colWidth\":[],\"reverse\":false,\"sIndex\":-1},\"peerTable\":{\"colMask\":250402,\"colOrder\":[],\"colWidth\":[],\"reverse\":false,\"sIndex\":-1},\"fileTable\":{\"colMask\":48,\"colOrder\":[],\"colWidth\":[],\"reverse\":false,\"sIndex\":-1},\"feedTable\":{\"colMask\":222,\"colOrder\":[],\"colWidth\":[],\"reverse\":false,\"sIndex\":-1},\"advOptTable\":{\"rowMultiSelect\":false},\"activeSettingsPane\":\"\",\"activeRssFeeds\":{\"rssfeed_all\":1},\"activeTorGroups\":{\"cat\":{\"cat_dls\":1},\"lbl\":{}}}",{"access"=>"Y"}],
      ["webui.uconnect_toolbar_ever", 1, "true", {"access"=>"R"}],
      ["webui.uconnect_enable_ever", 1, "true", {"access"=>"R"}],
      ...
      ["webui.update_message", 2, "A new stable version of \u00B5Torrent 3.4.2 (build 32239) is available. Would you like to download and install it?\r\nNew in this version:\r\n- Better UI Performance\r\n- Stability improvements and various bug fixes\r\n\r\n<a href=\"http://forum.utorrent.com/topic/88607-340-stable/\">Click here to view the complete list of changes in this release.</a>\r\n\r\nBy clicking \"Yes\", you acknowledge that you have read and agree to the <a href=\"http://www.bittorrent.com/legal/eula\">End User License Agreement</a> and <a href=\"http://www.bittorrent.com/legal/privacy\">Privacy Policy</a>.\r\n\r\nThis will also download the latest translations.", {"access"=>"R"}],
      ["webui.proxy_auth", 1, "true", {"access"=>"R"}],
      ["webui.update_url", 2, "http://pr.apps.bittorrent.com/client-webui/3.4/client-webui.json", {"access"=>"Y"}],
      ["diskio.sparse_files", 1, "false", {"access"=>"Y"}],
