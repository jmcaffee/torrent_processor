...
RSpec.configure do |config|
  # Don't set 'treat_symbols' anymore. It defaults to true and setting it here
  # results in a console message on every run.
  ...
  config.mock_with :rspec do |mocks|
    ...
    # Force method verification of partial doubles too
